...
public class AdditionalExerciseOptions extends ActionBarActivity {
    ...
    public void randNumWorkout (View v) {
        ...
        alert.setPositiveButton("Go!", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(AdditionalExerciseOptions.this);
    ...
    public void randPresetNumWorkout (View v) {
        Intent intent = new Intent(this, AdditionalExercisePresetOptions.class);
